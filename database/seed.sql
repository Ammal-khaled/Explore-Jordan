...
VALUES
  ...
  ('Dead Sea Floating', 'Dead Sea Region', 'Wellness', 'Float in the mineral-rich Dead Sea and enjoy one of Jordan''s most relaxing natural experiences.', 'The high salinity makes floating effortless, while many resorts and public beach areas offer access to showers and spa facilities. Visitors should avoid shaving beforehand, protect cuts, and keep water away from the eyes.', 'assets/images/DeadSea.jpg', '1 to 3 hours', '$$', 'https://www.google.com/maps/search/?api=1&query=Dead+Sea+Jordan', ARRAY['wellness', 'floating', 'spa', 'nature']::text[]),
  ('Jerash Ruins Tour', 'Jerash', 'History', 'Tour Jerash''s Roman streets, temples, theaters, and plazas with time to understand the city''s scale.', 'A guided visit helps bring the archaeological site to life, connecting the Oval Plaza, Cardo, theaters, gates, and temples into one coherent story. Jerash works well as a half-day trip from Amman or as part of a northern Jordan route.', 'assets/images/Jerash Ruins.jpg', '2 to 4 hours', '$', 'https://www.google.com/maps/search/?api=1&query=Jerash+Archaeological+Site+Jordan', ARRAY['roman', 'history', 'guided tour', 'archaeology']::text[]),
  ('Wadi Rum Jeep Tour', 'Wadi Rum', 'Adventure', 'Cover Wadi Rum''s major desert viewpoints, rock bridges, dunes, and canyons with a local driver-guide.', 'Jeep tours are a practical way to see more of the protected area in limited time while learning from local guides. Routes often include scenic stops, short walks, tea breaks, sunset viewpoints, and transfer to desert camps.', 'assets/images/Wadi Rum Jeep.jpg', '2 hours to full day', '$$', 'https://www.google.com/maps/search/?api=1&query=Wadi+Rum+Jeep+Tour', ARRAY['jeep tour', 'desert', 'bedouin', 'sunset']::text[]);
...
VALUES
  ('Luxury Stays', 'Amman, Petra, Dead Sea, and Aqaba', 'Luxury Hotel', '$$$', 'High-end hotels and resorts with polished service, strong locations, and comfortable amenities for longer itineraries.', 'Luxury stays in Jordan are strongest in Amman, Petra, the Dead Sea, and Aqaba, where travelers can pair sightseeing with full-service comfort. Expect refined rooms, restaurants, pools, concierge support, and easy access to major routes.', 'assets/images/Luxury Stays.jpg', 'https://www.booking.com/searchresults.html?ss=Jordan', ARRAY['luxury', 'hotel', 'comfort', 'full service']::text[]),
  ('Eco Lodges', 'Dana and Nature Reserves', 'Eco Lodge', '$$', 'Nature-focused lodges that support slower travel, local communities, and access to hiking routes.', 'Eco lodges are ideal for travelers who want quiet landscapes, guided walks, and a lighter environmental footprint. Dana and nearby reserve areas offer some of the best settings for simple, memorable stays connected to nature.', 'assets/images/Eco Lodges.jpg', 'https://www.rscn.org.jo', ARRAY['eco travel', 'nature', 'hiking', 'local community']::text[]),
  ('Desert Camps', 'Wadi Rum', 'Desert Camp', '$$', 'Wadi Rum camps offer desert views, evening meals, stargazing, and easy access to guided tours.', 'Desert camps range from simple Bedouin-style tents to more comfortable dome and cabin experiences. The best stays focus on good guiding, respectful hosting, clear transfers, and time to enjoy sunset and the night sky.', 'assets/images/Desert Camps.jpg', 'https://www.booking.com/searchresults.html?ss=Wadi+Rum%2C+Jordan', ARRAY['desert', 'wadi rum', 'stargazing', 'bedouin']::text[]),
